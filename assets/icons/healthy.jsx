...
function HealthySalad({ size = 24, color = "#000000" }) {
  return (
    <Svg
      height={size}
      width={size}
    ...
    >
      ...
      <G id="SVGRepo_iconCarrier">
        <Path
          fill="#434A54"
          d="M184.135,157.173c-2.344,0-4.703-0.766-6.672-2.344c-4.594-3.695-5.32-10.406-1.633-15
        ...
        <Path
          fill="#ED5564"
          d="M186.588,144.064c-20.75-53.303-71.444-52.842-107.654-16.632
        ...
        <Path
          fill="#A0D468"
          d="M346.598,76.12c-3.141,0-6.249-1.383-8.358-4.039c-0.672-0.844-6.609-8.586-9.141-20.679
        ...
        <Path
          fill="#E9573F"
          d="M356.63,227.281l38.281-12.656l40.186-13.281c47.875-15.828,14.203-176.191-24.952-163.246
          L279.382,81.331C240.071,94.323,308.616,243.156,356.63,227.281z"
        />
        <Path
          fill="#FC6E51"
          d="M422.613,105.08c-7.781-23.562-16.905-62.943-39.999-62.943c-2.375,0-4.875,0.414-7.547,1.297
        ...
        <Path
          fill="#A0D468"
          d="M437.315,298.679H74.66c-5.891,0-10.664,4.766-10.664,10.655v32
        ...
        <Path
          opacity="0.2"
          fill="#FFFFFF"
          d="M437.315,298.679h-21.327c5.891,0,10.672,4.766,10.672,10.655
